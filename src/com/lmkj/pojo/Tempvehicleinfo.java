...
/**
 * Tempvehicleinfo generated by hbm2java
 */
public class Tempvehicleinfo implements java.io.Serializable {
	...
	public Tempvehicleinfo(BigDecimal id) {
		this.id = id;
	}

	public Tempvehicleinfo(BigDecimal id, String vehicleid, String plateno, BigDecimal commandid, String orderid,
