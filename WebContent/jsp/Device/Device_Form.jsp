...
<body>
    <form method="post" action="${ctx}/Save_Device" id="device_form" style="width: 100%; height: 100%;" class="panel-noscroll"
    runat="server">
    <table>
        <tbody>
            <tr>
    ...
    <script type="text/javascript">
    <%-- function aa() {
                var  install= <%=this.dinfo.IsInstall%>;
                var  IsActivation= <%=this.dinfo.Activation%>;  
                  if(install==1)
                  {
