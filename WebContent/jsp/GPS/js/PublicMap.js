...
//只用于百度地图
function GetBaiduIcon(t, s, c, m) {
    if (s == "Arrears") {
        s = "Offline";
    }
    var bIcon = new BMap.Icon("icons/green", new BMap.Size(15, 30));
    ...
    if ((course >= 0 && course < 22.5) || (course >= 337.5 && course < 360) || course >= 360) // 0,360
    {
        if (t == 1) {
            ...
            bIcon = new BMap.Icon(icon, new BMap.Size(32, 32));
        } else if (t == 2) {
            icon = "icons/carIcon/2.png";
            bIcon = new BMap.Icon(icon, new BMap.Size(15, 20));
        } else if (t == 21) {
            if (s == "Offline") {
                icon = "icons/carIcon/offline_27_0.png";
            } else {
            ...
            if (s == "Offline") {
                ...
                if (m == 0) {
                    icon = "icons/carIcon/32_0.png";
                }
                else {
                    icon = "icons/carIcon/32_0_clock.png";
                }
            }
            bIcon = new BMap.Icon(icon, new BMap.Size(32, 32));
        }
    ...
    else if (course >= 22.5 && course < 67.5) // 45
    {
        if (t == 1) {
            ...
            if (s == "Offline") {
                ...
                if (m == 0) {
                    icon = "icons/carIcon/32_45.png";
                } else {
                    icon = "icons/carIcon/32_45_clock.png";
                }
            }
            bIcon = new BMap.Icon(icon, new BMap.Size(32, 32));
        }
    ...
    else if (course >= 67.5 && course < 112.5) // 90
    {
        if (t == 1) {
            ...
            if (s == "Offline") {
                ...
                if (m == 0) {
                    icon = "icons/carIcon/32_90.png";
                } else {
                    icon = "icons/carIcon/32_90_clock.png";
                }
            }
            bIcon = new BMap.Icon(icon, new BMap.Size(32, 32));
        }
    ...
    else if (course >= 112.5 && course < 157.5) //135
    {
        if (t == 1) {
            ...
            if (s == "Offline") {
                ...
                if (m == 0) {
                    icon = "icons/carIcon/32_135.png";
                } else {
                    icon = "icons/carIcon/32_135_clock.png";
                }
            }
            bIcon = new BMap.Icon(icon, new BMap.Size(32, 32));
        }
    ...
    else if (course >= 157.5 && course < 202.5) //180
    {
        if (t == 1) {
            ...
            if (s == "Offline") {
                ...
                if (m == 0) {
                    icon = "icons/carIcon/32_180.png";
                } else {
                    icon = "icons/carIcon/32_180_clock.png";
                }
            }
            bIcon = new BMap.Icon(icon, new BMap.Size(32, 32));
        }
    ...
    else if (course >= 202.5 && course < 247.5) //225
    {
        if (t == 1) {
            ...
            if (s == "Offline") {
                ...
                if (m == 0) {
                    icon = "icons/carIcon/32_225.png";
                } else {
                    icon = "icons/carIcon/32_225_clock.png";
                }
            }
            bIcon = new BMap.Icon(icon, new BMap.Size(32, 32));
        }
    ...
    else if (course >= 247.5 && course < 292.5) //270
    {
        if (t == 1) {
            ...
            if (s == "Offline") {
                ...
                if (m == 0) {
                    icon = "icons/carIcon/32_270.png";
                } else {
                    icon = "icons/carIcon/32_270_clock.png";
                }
            }
            bIcon = new BMap.Icon(icon, new BMap.Size(32, 32));
        }
    ...
    else if (course >= 292.5 && course < 337.5) //315
    {
        if (t == 1) {
            ...
            if (s == "Offline") {
                ...
                if (m == 0) {
                    icon = "icons/carIcon/32_315.png";
                } else {
                    icon = "icons/carIcon/32_315_clock.png";
                }
            }
            bIcon = new BMap.Icon(icon, new BMap.Size(32, 32));
        }
...
function GetSOSOIcon(t, s, c) {
    ...
    var course = parseFloat(c);
    var icon = "";
    var offsetPoint = new qq.maps.Point(28, 28), iconSize = new qq.maps.Size(28, 28);
    if ((course >= 0 && course < 22.5) || (course >= 337.5 && course < 360) || course >= 360) // 0,360
    {
        if (t == 1) {
            if (s == "Offline") {
            ...
            icon = "icons/carIcon/2.png";
            offsetPoint = new qq.maps.Point(14, 18), iconSize = new qq.maps.Size(14, 18);
            ...
            offsetPoint = new qq.maps.Point(24, 24), iconSize = new qq.maps.Size(24, 24);
        } else if (t == 24) {
            if (s == "Offline") {
                icon = "icons/carIcon/offline_24_0.png";
            } else {
    ...
    if (t == 30) {
        ...
        offsetPoint = new qq.maps.Point(28, 28), iconSize = new qq.maps.Size(28, 28);
    } else if (t == 31) {
        if (s == "Offline") {
            icon = "icons/carIcon/offline_31.png";
        } else {
    ...
    //    sIcon = new qq.maps.MarkerImage(icon, iconSize, offsetPoint);
    sIcon = new qq.maps.MarkerImage(icon, iconSize, new qq.maps.Point(0, 0), new qq.maps.Point(28, 28));
    return sIcon;
}