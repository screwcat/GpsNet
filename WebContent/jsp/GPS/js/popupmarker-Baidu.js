...
PopupMarker.prototype.onAdd = function () {
    this.container_ = document.createElement("div");
    this.iconContainer = document.createElement("div");
    var panes = this.getPanes ? this.getPanes() : this.map_.getPanes();
...
PopupMarker.prototype.redrawNormalPopup_ = function (text) {
    if (this.beforeNormalPopupText_ !== text) {
        ...
        //调试
//        $(rightBody_).css("left", ($(this.container_).offset().left + $(this.container_).width() - $(rightBody_).width()) + "px");
//        $(bodyContainer_).css("width", ($(this.container_).width() - $(rightBody_).outerWidth(true) - $(leftBody_).outerWidth(true) - 9) + "px");
//        $(centerBottom_).css("width", $(bodyContainer_).width() + "px");
//        $(centerTop_).css("width", $(bodyContainer_).width() + "px");
