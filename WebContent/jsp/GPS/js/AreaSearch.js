(function ($) {
    ...
    $.getDrawingManager = function () {
        ...
        //                }
        //                //                map.removeOverlay($.getCurrRact());
        //            }
        //            map.addOverlay(overlay);
        //            $.addCurrRacts(overlay);
        //            if (/function/.test(typeof oper)) {
        //                oper();
        //            }
        //            //            currRact = overlay;
    ...
    $.getAreaSearchBounds = function () {
        return areaSearchBounds;
    };
    $.setAreaSearchBounds = function (bounds) {
        areaSearchBounds = bounds;
    };
...
function rectArea() {
    ...
    drawingManager.addEventListener("rectanglecomplete", function (overlay) {
        ...
        map.addOverlay(overlay);
        $.addCurrRacts(overlay);
        $.setAreaSearchBounds(overlay.getBounds());
    });
    drawingManager.open();
...
//                                "</td>" +
//                                "<td style=\"text-align: center; padding: 0px;\">" +
//                        //                                    "<a href=\"Playback.aspx?deviceid=" + data[i].imei + "\">轨迹回放</a>" +
