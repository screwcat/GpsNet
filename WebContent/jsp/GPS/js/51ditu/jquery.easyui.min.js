...
(function ($) {
    ...
    $.fn.pagination.defaults = {
        total: 1, pageSize: 10, pageNumber: 1, pageList: [10, 20, 30, 50], loading: false, buttons: null, showPageList: true, showRefresh: true, onSelectPage: function (_9f, _a0) {
...
(function ($) {
    ...
    function _fe(_ff, ul, data, _100) {
        ...
        function _104(ul, _106, _107) {
            for (var i = 0; i < _106.length; i++) {
                ...
                $.data(node[0], "tree-node", { id: item.id, text: item.text, pid: item.pid, iconCls: item.iconCls, attributes: item.attributes });
    ...
    $.fn.tree.defaults = {
        url: null, method: "post", animate: true, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, dnd: false, data: null, formatter: function (node) {
            return node.text;
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _190, dataType: "json", success: function (data) {
                    _191(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.progressbar.defaults = {
        width: "auto", height: 22, value: 0, text: "{value}%", onChange: function (_1af, _1b0) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    function _233(_234) {
        ...
        var win = $(_234).panel($.extend({}, _235.options, {
            border: false, doSize: true, closed: true, cls: "window", headerCls: "window-header", bodyCls: "window-body " + (_235.options.noheader ? "window-body-noheader" : ""), onBeforeDestroy: function () {
    ...
    function _239(_23a) {
        ...
        _23b.window.draggable({
            handle: ">div.panel-header>div.panel-title", disabled: _23b.options.draggable == false, onStartDrag: function (e) {
                if (_23b.mask) {
        ...
        _23b.window.resizable({
            disabled: _23b.options.resizable == false, onStartResize: function (e) {
...
(function ($) {
    ...
    function _248(_249) {
        ...
        opts.content = null;
        _24a.panel({
            closed: opts.closed, cache: opts.cache, href: _24e, content: _24f, onLoad: function () {
                if (opts.height == "auto") {
                    $(_249).window("resize");
                }
...
(function ($) {
    ...
    function _262(_263) {
        var opts = $.extend({}, $.fn.window.defaults, {
            collapsible: false, minimizable: false, maximizable: false, shadow: true, draggable: false, resizable: false, closed: true, style: { left: "", top: "", right: 0, zIndex: $.fn.window.defaults.zIndex++, bottom: -document.body.scrollTop - document.documentElement.scrollTop }, onBeforeOpen: function () {
    ...
    function _264(_265, _266, _267) {
        ...
        win.window({
            title: _265, noheader: (_265 ? false : true), width: 300, height: "auto", modal: true, collapsible: false, minimizable: false, maximizable: false, resizable: false, onClose: function () {
                setTimeout(function () {
                    win.window("destroy");
                }, 100);
            }
...
(function ($) {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, onSelect: function (_2bb, _2bc) {
...
(function ($) {
    ...
    function _2e8(_2e9, pp, _2ea) {
        ...
        pp.panel($.extend({}, _2ea, {
            border: false, noheader: true, closed: true, doSize: false, iconCls: (_2ea.icon ? _2ea.icon : undefined), onLoad: function () {
                if (_2ea.onLoad) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 27, plain: false, fit: false, border: true, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_321) {
    ...
    function _341(_342, _343, el) {
        ...
        if (pp.panel("options").split) {
            ...
            _348.resizable($.extend({}, {
                handles: _349, onStartResize: function (e) {
                    _32e = true;
...
(function ($) {
    ...
    $.fn.searchbox.defaults = {
        width: "auto", height: 22, prompt: "", value: "", menu: null, searcher: function (_3e6, name) {
        }
    };
})(jQuery);
(function ($) {
...
(function ($) {
    ...
    function load(_417, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _418, dataType: "json", success: function (data) {
                    _419(data);
                }, error: function () {
    ...
    $.fn.form.defaults = {
        url: null, onSubmit: function (_42c) {
...
(function ($) {
    ...
    function _4ec(_4ed) {
        ...
        _4ef.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_4f0, _4f1) {
                setTimeout(function () {
        ...
        if (opts.pagination) {
            ...
            _4f4.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_4f5, _4f6) {
    ...
    function _500(_501) {
        ...
        _505.each(function () {
            $(this).resizable({
                handles: _50d, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _502.resizing = true;
    ...
    $.fn.datagrid = function (_5e6, _5e7) {
        if (typeof _5e6 == "string") {
            if (_5e6 == "loadData") {
                try {
                    $.fn.datagrid.methods["clearSelections"](this, _5e7);
                } catch (e) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", autoRowHeight: true, toolbar: null, striped: true, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", rownumbers: false, singleSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollbarSize: 18, rowStyler: function (_695, _696) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _697, dataType: "json", success: function (data) {
                    _698(data);
                }, error: function () {
...
(function ($) {
    ...
    function _6c1(_6c2) {
        ...
        $(_6c2).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? _6c4 : undefined), onClickRow: function (_6c5, row) {
                if (_6c0 != this) {
                    _6c6(_6c0);
                    _6c0 = this;
                }
    ...
    $.fn.propertygrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        singleSelect: true, remoteSort: false, fitColumns: true, loadMsg: "", frozenColumns: [[{ field: "f", width: 16, resizable: false }]], columns: [[{ field: "name", title: "Name", width: 100, sortable: true }, { field: "value", title: "Value", width: 100, resizable: false }]], showGroup: false, groupField: "group", groupFormatter: function (_6ec, rows) {
            return _6ec;
        }
    });
})(jQuery);
(function ($) {
    function _6ed(_6ee) {
        ...
        if (opts.pagination) {
            ...
            _703.pagination({
                pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_704, _705) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, animate: true, singleSelect: true, view: _77a, loader: function (_7b1, _7b2, _7b3) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            $.ajax({
                type: opts.method, url: opts.url, data: _7b1, dataType: "json", success: function (data) {
                    _7b2(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupField: null, groupFormatter: function (_84f) {
            return _84f;
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _850, dataType: "json", success: function (data) {
                    _851(data);
                }, error: function () {
...
(function ($) {
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, value: 0, min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_8ff) {
            return _8ff;
