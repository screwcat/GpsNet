...
$(document).ready(function () {
    ...
    $(window).resize(function () {
        //        $("#main")[0].contentWindow.syncSize();
        if ($.trim($("#fullreturn").css("display")) != "none") {
            $("#Content").css({
...
function Maximize() {
    ...
    $("#main")[0].contentWindow.syncSize();
    if ($("#main")[0].contentWindow != null &&
        $.trim($("#main")[0].contentWindow.$.getMapType()) == "Baidu") {
        if ($("#main")[0].contentWindow.$.getMapObj() != null) {
            if ($("#main")[0].contentWindow.$.getViewPoints() != null) {
                $("#main")[0].contentWindow.$.getMapObj().setViewport($("#main")[0]
                    .contentWindow.$.getViewPoints());
            } else if ($("#main")[0].contentWindow.$.getCenterPoint() != null) {
                $("#main")[0].contentWindow.$.getMapObj().centerAndZoom($("#main")[0]
                    .contentWindow.$.getCenterPoint());
            }
        }
    } else if ($("#main")[0].contentWindow != null &&
        $.trim($("#main")[0].contentWindow.$.getMapType()) == "Google") {
        if ($("#main")[0].contentWindow.$.getMapObj() != null) {
            if ($("#main")[0]
                .contentWindow.$.getLatLngBounds() != null) {
                $("#main")[0].contentWindow.$.getMapObj().fitBounds(
                    $("#main")[0].contentWindow.$.getLatLngBounds()
                );
            } else if ($("#main")[0].contentWindow.$.getCenterPoint() != null) {
                $("#main")[0].contentWindow.$.getMapObj().setCenter($("#main")[0]
                    .contentWindow.$.getCenterPoint());
            }
        }
    }
...
function Fullrestore() {
    ...
    $("#main")[0].contentWindow.syncSize();
    if ($("#main")[0].contentWindow != null && $.trim($("#main")[0].contentWindow.$.getMapType()) == "Baidu") {
        if ($("#main")[0].contentWindow.$.getMapObj() != null) {
            if ($("#main")[0].contentWindow.$.getViewPoints() != null) {
                $("#main")[0].contentWindow.$.getMapObj().setViewport($("#main")[0].contentWindow.$.getViewPoints());
            } else if ($("#main")[0].contentWindow.$.getCenterPoint() != null) {
                $("#main")[0].contentWindow.$.getMapObj().centerAndZoom($("#main")[0]
                    .contentWindow.$.getCenterPoint());
            }
        ...
        $.trim($("#main")[0].contentWindow.$.getMapType()) == "Google") {
        if ($("#main")[0].contentWindow.$.getMapObj() != null) {
            if ($("#main")[0].contentWindow.$.getLatLngBounds() != null) {
                $("#main")[0].contentWindow.$.getMapObj().fitBounds(
                    $("#main")[0].contentWindow.$.getLatLngBounds()
                );
            } else if ($("#main")[0]
                        .contentWindow.$.getCenterPoint() != null) {
                $("#main")[0].contentWindow.$.getMapObj().setCenter($("#main")[0]
                    .contentWindow.$.getCenterPoint());
            }
        }
